...
TEXTS = {'ar': {'welcome': 'أهلاً وسهلاً بك في أكاديمية الكنغ التعليمية. يرجى اختيار اللغة للمتابعة:',
        ...
        'payment': 'طرق الدفع',
        'availability': 'متى تتوفر الأسئلة؟',
        'contact': 'التواصل مع الإدارة',
        'send_contact': 'يرجى كتابة رسالتك كاملة الآن، مع توضيح الطلب أو الاستفسار. سيتم حفظ الرسالة '
                        'وتحويلها للإدارة.',
        ...
        'intensive_text': 'تفاصيل الاشتراك في مجموعة التدريب المكثف:\n'
                          ...
                          '\n'
                          'كما يتم تنظيم امتحان تجريبي كامل لمستوى B1 كل أسبوع، بهدف تقييم مستوى الطلاب، '
                          'تحديد نقاط الضعف، والعمل على تحسينها بشكل عملي ومنظم.',
        'schedule_text': 'مواعيد التدريب المكثف:\n'
                         ...
                         '\n'
                         'بالإضافة إلى ذلك، تشرف الآنسة ليلى على تدريبات إضافية من الاثنين إلى الخميس، ويكون '
                         'الموعد غالباً بعد الظهر حوالي الساعة 3:00 أو في الفترة الصباحية.\n'
                         '\n'
                         'أما أيام الجمعة والسبت والأحد، فقد يتم تنظيم تدريبات إضافية حسب توفر الوقت لدى '
                         'الآنسة ليلى، ويتم إبلاغ الطلاب مسبقاً بوقت التدريب وموضوع الدرس.',
        'b1_text': 'للاستفسار عن الأسئلة والمواد المفيدة الخاصة بامتحان B1 (DTZ)، يرجى إرسال المعلومات '
                   'التالية برسالة واحدة:\n'
                   '\n'
                   '1. تاريخ الامتحان\n'
                   '2. وقت بدء الامتحان\n'
        ...
        'b2_text': 'للاستفسار عن الأسئلة والمواد المفيدة الخاصة بامتحان B2 (DTB)، يرجى إرسال المعلومات '
                   'التالية برسالة واحدة:\n'
                   '\n'
                   '1. تاريخ الامتحان\n'
                   '2. وقت بدء الامتحان\n'
        ...
        'availability_text': 'تتوفر الأسئلة والمواد المفيدة قبل أسبوع من موعد الامتحان.\n'
                             '\n'
                             'ويتم تقديمها للطالب قبل 3 إلى 4 أيام من الامتحان، حسب موعد الامتحان وتجهيز '
                             'الملف.',
        'contact_text': 'للتواصل مع الإدارة، يرجى كتابة سبب المراسلة بشكل واضح وكامل.\n'
                        '\n'
                        'يرجى عدم الاكتفاء بإرسال التحية فقط؛ اكتب طلبك أو استفسارك كاملاً حتى تتمكن الإدارة '
                        'من مساعدتك بسرعة ودقة.\n'
                        '\n'
                        'رابط الإدارة:\n'
                        'https://t.me/Alking03'},
 'de': {'welcome': 'Willkommen bei der King Bildungsakademie. Bitte wählen Sie Ihre Sprache aus:',
        'privacy': 'Hinweis: Ihre Daten und Nachrichten werden ausschließlich zur Bearbeitung von '
                   'Supportanfragen, zur Nachverfolgung und zur Vermeidung mehrfacher Anfragen gespeichert.',
        ...
        'availability': 'Wann sind die Fragen verfügbar?',
        'contact': 'Kontakt zur Verwaltung',
        'send_contact': 'Bitte schreiben Sie jetzt Ihre vollständige Nachricht und beschreiben Sie Ihr '
                        'Anliegen klar. Die Nachricht wird gespeichert und an die Verwaltung weitergeleitet.',
        ...
        'spam_wait': 'Bitte warten Sie einen Moment, bevor Sie eine weitere Nachricht senden, damit Ihre '
                     'Anfrage geordnet bearbeitet werden kann.',
        'spam_hour': 'Sie haben innerhalb kurzer Zeit zu viele Nachrichten gesendet. Bitte versuchen Sie es '
                     'später erneut.',
        'unknown': 'Bitte wählen Sie einen Service über die angezeigten Buttons aus oder senden Sie /start, '
                   'um neu zu beginnen.',
        'intensive_text': 'Details zur Teilnahme an der Intensivtrainingsgruppe:\n'
                          ...
                          '\n'
                          'Zusätzlich findet jede Woche eine vollständige B1-Probeprüfung statt. Ziel ist '
                          'es, den aktuellen Lernstand der Teilnehmenden zu bewerten, Schwächen zu erkennen '
                          'und diese strukturiert zu verbessern.',
        'schedule_text': 'Termine des Intensivtrainings:\n'
                         '\n'
                         'Montag, Dienstag, Mittwoch:\n'
                         'Von 21:00 bis 23:00 Uhr\n'
                         'Trainingsinhalte: mündlicher Teil, Bildbeschreibung, Pläne sowie das Schreiben von '
                         'Brief und E-Mail.\n'
                         '\n'
                         'Donnerstag:\n'
                         'Probeprüfung ab 21:00 Uhr.\n'
                         '\n'
                         'Zusätzlich betreut Frau Layla von Montag bis Donnerstag weitere '
                         'Trainingseinheiten. Die Termine liegen meistens nachmittags gegen 15:00 Uhr oder '
                         'am Vormittag.\n'
                         '\n'
                         'Freitag, Samstag und Sonntag können je nach Verfügbarkeit von Frau Layla '
                         'zusätzliche Trainingseinheiten stattfinden. Die Teilnehmenden werden rechtzeitig '
                         'über Uhrzeit und Thema informiert.',
        'b1_text': 'Für Anfragen zu den hilfreichen Fragen und Materialien für B1 (DTZ) senden Sie bitte die '
                   'folgenden Informationen in einer einzigen Nachricht:\n'
                   '\n'
                   ...
                   '\n'
                   'Nach dem Senden werden Ihre Angaben gespeichert und zur weiteren Bearbeitung an die '
                   'Verwaltung weitergeleitet.',
        'b1_price_text': 'Preis für B1 (DTZ) Materialien und Fragen:\n200€',
        'b2_text': 'Für Anfragen zu den hilfreichen Fragen und Materialien für B2 (DTB) senden Sie bitte die '
                   'folgenden Informationen in einer einzigen Nachricht:\n'
                   '\n'
                   '1. Datum Ihrer Prüfung\n'
                   '2. Beginnzeit Ihrer Prüfung\n'
        ...
        'payment_text': 'Verfügbare Zahlungsmethoden:\n'
                        ...
                        '\n'
                        'Für die passenden Zahlungsdaten kontaktieren Sie bitte die Verwaltung und nennen '
                        'Sie den gewünschten Service.',
        'availability_text': 'Die hilfreichen Fragen und Materialien sind eine Woche vor dem Prüfungstermin '
                             'verfügbar.\n'
                             '\n'
                             'Sie werden dem Schüler bzw. der Schülerin 3 bis 4 Tage vor der Prüfung '
                             'bereitgestellt, abhängig vom Prüfungstermin und der Vorbereitung der '
                             'Unterlagen.',
        'contact_text': 'Für den Kontakt mit der Verwaltung schreiben Sie bitte Ihr Anliegen klar und '
                        'vollständig.\n'
                        '\n'
                        'Bitte senden Sie nicht nur eine Begrüßung, sondern beschreiben Sie Ihre Anfrage '
                        'oder Ihr Problem vollständig, damit die Verwaltung Ihnen schnell und gezielt helfen '
                        'kann.\n'
                        '\n'
                        'Link zur Verwaltung:\n'
                        'https://t.me/Alking03'},
 'tr': {'welcome': 'King Eğitim Akademisi’ne hoş geldiniz. Devam etmek için lütfen dilinizi seçin:',
        'privacy': 'Bilgilendirme: Bilgileriniz ve mesajlarınız yalnızca destek taleplerinin takibi, '
                   'düzenlenmesi ve tekrar eden başvuruların önlenmesi amacıyla kaydedilir.',
        ...
        'availability': 'Sorular ne zaman hazır olur?',
        'contact': 'Yönetim ile iletişim',
        'send_contact': 'Lütfen mesajınızı şimdi eksiksiz şekilde yazın ve talebinizi açıkça belirtin. '
                        'Mesajınız kaydedilip yönetime iletilecektir.',
        'request_saved': 'Talebiniz başarıyla alındı ve kaydedildi ✅\n'
                         'İncelenmesi için yönetime iletilecektir.',
        'spam_wait': 'Talebinizin düzenli şekilde işlenebilmesi için lütfen yeni bir mesaj göndermeden önce '
        ...
        'intensive_text': 'Yoğun eğitim grubuna katılım detayları:\n'
                          ...
                          '• Sınava daha iyi hazırlanmayı sağlayan önemli ve sık tekrar eden sınav '
                          'örnekleri\n'
                          '\n'
                          'Ayrıca öğrencilerin seviyesini değerlendirmek, zayıf noktaları belirlemek ve bu '
                          'noktalar üzerinde düzenli şekilde çalışmak amacıyla her hafta tam bir B1 deneme '
                          'sınavı yapılır.',
        'schedule_text': 'Yoğun eğitim programı:\n'
                         '\n'
                         'Pazartesi, Salı, Çarşamba:\n'
                         'Saat 21:00 - 23:00\n'
                         'Eğitim içeriği: konuşma bölümü, resim anlatımı, planlar, Brief ve E-Mail yazma '
                         'yöntemi.\n'
                         '\n'
                         'Perşembe:\n'
                         'Deneme sınavı saat 21:00’de başlar.\n'
                         '\n'
                         'Buna ek olarak, Leyla Hanım pazartesiden perşembeye kadar ek eğitimleri takip '
                         'eder. Saat genellikle öğleden sonra 15:00 civarında veya sabah saatlerinde olur.\n'
                         '\n'
        ...
        'b1_text': 'B1 (DTZ) için faydalı sorular ve materyaller hakkında bilgi almak istiyorsanız, lütfen '
                   'aşağıdaki bilgileri tek mesaj halinde gönderin:\n'
                   '\n'
                   '1. Sınav tarihiniz\n'
        ...
        'b2_text': 'B2 (DTB) için faydalı sorular ve materyaller hakkında bilgi almak istiyorsanız, lütfen '
                   'aşağıdaki bilgileri tek mesaj halinde gönderin:\n'
                   '\n'
                   '1. Sınav tarihiniz\n'
                   '2. Sınav başlangıç saatiniz\n'
        ...
        'payment_text': 'Mevcut ödeme yöntemleri:\n'
                        ...
                        '3. Suriye’ye havale\n'
                        '\n'
                        'Uygun ödeme bilgilerini almak için lütfen yönetimle iletişime geçin ve almak '
                        'istediğiniz hizmeti belirtin.',
        'availability_text': 'Faydalı sorular ve materyaller sınav tarihinden bir hafta önce hazır olur.\n'
                             '\n'
                             'Öğrenciye sınavdan 3 ila 4 gün önce teslim edilir. Bu süre, sınav tarihine ve '
                             'dosyanın hazırlanma durumuna göre değişebilir.',
        'contact_text': 'Yönetimle iletişime geçmek için lütfen mesaj nedeninizi açık ve eksiksiz şekilde '
                        'yazın.\n'
                        '\n'
                        'Sadece selam göndermek yerine, talebinizi veya sorunuzu tam olarak belirtmeniz, '
                        'yönetimin size daha hızlı ve doğru şekilde yardımcı olmasını sağlar.\n'
                        '\n'
                        'Yönetim bağlantısı:\n'
                        'https://t.me/Alking03'},
 'uk': {'welcome': 'Вітаємо в освітній академії King. Будь ласка, оберіть мову для продовження:',
        ...
        'availability': 'Коли будуть доступні питання?',
        'contact': 'Зв’язок з адміністрацією',
        'send_contact': 'Будь ласка، напишіть повне повідомлення та чітко опишіть свій запит. Повідомлення '
                        'буде збережено й передано адміністрації.',
        'request_saved': 'Ваш запит успішно отримано та збережено ✅\n'
                         'Його буде передано адміністрації для подальшої обробки.',
        'spam_wait': 'Будь ласка, зачекайте трохи перед надсиланням нового повідомлення, щоб ваш запит було '
                     'оброблено належним чином.',
        'spam_hour': 'Ви надіслали занадто багато повідомлень за короткий час. Будь ласка, спробуйте '
                     'пізніше.',
        ...
        'intensive_text': 'Деталі участі в групі інтенсивного навчання:\n'
                          ...
                          '\n'
                          'Також щотижня проводиться повний пробний іспит рівня B1, щоб оцінити рівень '
                          'студентів, визначити слабкі місця та системно працювати над їх покращенням.',
        'schedule_text': 'Розклад інтенсивного навчання:\n'
                         '\n'
                         'Понеділок, вівторок, середа:\n'
                         'З 21:00 до 23:00\n'
                         'Зміст занять: усна частина, опис зображень, плани, а також написання Brief та '
                         'E-Mail.\n'
                         '\n'
                         'Четвер:\n'
                         'Пробний іспит починається о 21:00.\n'
                         '\n'
                         'Крім того, пані Лейла проводить додаткові тренування з понеділка по четвер. Час '
                         'зазвичай припадає на післяобідній період близько 15:00 або на ранок.\n'
                         '\n'
                         'У п’ятницю, суботу та неділю додаткові заняття можуть проводитися залежно від '
                         'наявності часу у пані Лейли. Про час і тему заняття студентів повідомляють '
                         'заздалегідь.',
        'b1_text': 'Для запиту щодо корисних питань і матеріалів для B1 (DTZ) надішліть, будь ласка, такі '
                   'дані одним повідомленням:\n'
                   '\n'
                   ...
                   '\n'
                   'Після надсилання ваш запит буде збережено та передано адміністрації для подальшої '
                   'обробки.',
        'b1_price_text': 'Вартість матеріалів і питань B1 (DTZ):\n200€',
        'b2_text': 'Для запиту щодо корисних питань і матеріалів для B2 (DTB) надішліть, будь ласка, такі '
                   'дані одним повідомленням:\n'
                   '\n'
                   '1. Дату вашого іспиту\n'
                   '2. Час початку іспиту\n'
        ...
        'payment_text': 'Доступні способи оплати:\n'
                        ...
                        '3. Переказ до Сирії\n'
                        '\n'
                        'Щоб отримати відповідні платіжні реквізити, зв’яжіться з адміністрацією та вкажіть '
                        'потрібну послугу.',
        'availability_text': 'Корисні питання та матеріали доступні за один тиждень до дати іспиту.\n'
                             '\n'
                             'Студент отримує їх за 3–4 дні до іспиту, залежно від дати іспиту та підготовки '
                             'файлу.',
        'contact_text': 'Щоб зв’язатися з адміністрацією, будь ласка, чітко й повністю опишіть причину '
                        'звернення.\n'
                        '\n'
                        'Не надсилайте лише привітання — повний опис вашого запиту допоможе адміністрації '
                        'швидше й точніше вам відповісти.\n'
                        '\n'
                        'Посилання на адміністрацію:\n'
                        'https://t.me/Alking03'},
 'ur': {'welcome': 'کنگ ایجوکیشنل اکیڈمی میں خوش آمدید۔ جاری رکھنے کے لیے براہ کرم اپنی زبان منتخب کریں:',
        'privacy': 'اطلاع: آپ کی معلومات اور پیغامات صرف سپورٹ درخواستوں کی پیروی، تنظیم اور بار بار آنے '
                   'والی درخواستوں کو روکنے کے مقصد سے محفوظ کیے جاتے ہیں۔',
        ...
        'availability': 'سوالات کب دستیاب ہوں گے؟',
        'contact': 'انتظامیہ سے رابطہ',
        'send_contact': 'براہ کرم اپنا مکمل پیغام ابھی لکھیں اور اپنی درخواست واضح طور پر بیان کریں۔ پیغام '
                        'محفوظ کر کے انتظامیہ کو بھیجا جائے گا۔',
        'request_saved': 'آپ کی درخواست کامیابی سے موصول اور محفوظ کر لی گئی ہے ✅\n'
                         'اسے مزید کارروائی کے لیے انتظامیہ کو بھیجا جائے گا۔',
        'spam_wait': 'براہ کرم نیا پیغام بھیجنے سے پہلے تھوڑا انتظار کریں تاکہ آپ کی درخواست منظم طریقے سے '
                     'دیکھی جا سکے۔',
        'spam_hour': 'آپ نے مختصر وقت میں بہت زیادہ پیغامات بھیجے ہیں۔ براہ کرم بعد میں دوبارہ کوشش کریں۔',
        'unknown': 'براہ کرم دکھائے گئے بٹنوں میں سے کوئی سروس منتخب کریں یا دوبارہ شروع کرنے کے لیے /start '
                   'بھیجیں۔',
        'intensive_text': 'انتہائی تربیتی گروپ میں شمولیت کی تفصیلات:\n'
                          ...
                          '\n'
                          'اس کے علاوہ ہر ہفتے مکمل B1 آزمائشی امتحان لیا جاتا ہے، تاکہ طلبہ کی سطح کا '
                          'اندازہ لگایا جا سکے، کمزور نکات معلوم کیے جا سکیں، اور ان پر منظم طریقے سے کام '
                          'کیا جا سکے۔',
        'schedule_text': 'انتہائی تربیت کے اوقات:\n'
                         '\n'
                         'پیر، منگل، بدھ:\n'
                         'رات 9:00 بجے سے 11:00 بجے تک\n'
                         'تربیتی مواد: زبانی حصہ، تصاویر کی وضاحت، پلانز، اور Brief و E-Mail لکھنے کا '
                         'طریقہ۔\n'
                         '\n'
                         'جمعرات:\n'
                         'آزمائشی امتحان رات 9:00 بجے شروع ہوتا ہے۔\n'
                         '\n'
                         'اس کے علاوہ پیر سے جمعرات تک مس لیلیٰ اضافی تربیت کی نگرانی کرتی ہیں۔ وقت عموماً '
                         'دوپہر تقریباً 3:00 بجے یا صبح ہوتا ہے۔\n'
                         '\n'
                         'جمعہ، ہفتہ اور اتوار کو بھی مس لیلیٰ کی دستیابی کے مطابق اضافی تربیت ہو سکتی ہے۔ '
                         'وقت اور سبق کے موضوع سے طلبہ کو پہلے آگاہ کر دیا جاتا ہے۔',
        'b1_text': 'B1 (DTZ) کے مفید سوالات اور مواد کے بارے میں معلومات کے لیے براہ کرم درج ذیل معلومات ایک '
                   'ہی پیغام میں بھیجیں:\n'
                   '\n'
                   ...
                   '\n'
                   'معلومات بھیجنے کے بعد آپ کی درخواست محفوظ کر کے مزید کارروائی کے لیے انتظامیہ کو بھیج دی '
                   'جائے گی۔',
        'b1_price_text': 'B1 (DTZ) مواد اور سوالات کی قیمت:\n200€',
        'b2_text': 'B2 (DTB) کے مفید سوالات اور مواد کے بارے میں معلومات کے لیے براہ کرم درج ذیل معلومات ایک '
                   'ہی پیغام میں بھیجیں:\n'
                   '\n'
                   '1. آپ کے امتحان کی تاریخ\n'
                   '2. امتحان شروع ہونے کا وقت\n'
        ...
        'payment_text': 'دستیاب ادائیگی کے طریقے:\n'
                        ...
                        '3. شام کے لیے حوالہ\n'
                        '\n'
                        'مناسب ادائیگی کی تفصیلات حاصل کرنے کے لیے براہ کرم انتظامیہ سے رابطہ کریں اور '
                        'مطلوبہ سروس واضح کریں۔',
        'availability_text': 'مفید سوالات اور مواد امتحان کی تاریخ سے ایک ہفتہ پہلے دستیاب ہوتے ہیں۔\n'
                             '\n'
                             'یہ مواد طالب علم کو امتحان سے 3 سے 4 دن پہلے فراہم کیا جاتا ہے، امتحان کی '
                             'تاریخ اور فائل کی تیاری کے مطابق۔',
        'contact_text': 'انتظامیہ سے رابطہ کرنے کے لیے براہ کرم اپنی درخواست کی وجہ واضح اور مکمل طور پر '
                        'لکھیں۔\n'
                        '\n'
                        'صرف سلام بھیجنے کے بجائے، اپنی درخواست یا سوال مکمل طور پر لکھیں تاکہ انتظامیہ آپ '
                        'کی جلد اور درست مدد کر سکے۔\n'
                        '\n'
                        'انتظامیہ کا لنک:\n'
                        'https://t.me/Alking03'}}
...
def save_admin_message_map(admin_message_id: int, user_id: int, language: str, request_id: int) -> None:
    with db() as conn:
        conn.execute("""
            INSERT OR REPLACE INTO admin_message_map (admin_message_id, user_id, language, request_id, created_at)
            VALUES (?, ?, ?, ?, ?)
        """, (admin_message_id, user_id, language, request_id, now_iso()))
        conn.commit()


def get_admin_message_map(admin_message_id: int) -> Optional[sqlite3.Row]:
    with db() as conn:
        return conn.execute(
            "SELECT user_id, language, request_id FROM admin_message_map WHERE admin_message_id = ?",
            (admin_message_id,),
        ).fetchone()
...
def main_menu_keyboard(lang: str) -> InlineKeyboardMarkup:
    ...
    rows = [
        ...
        [InlineKeyboardButton(t["availability"], callback_data="menu:availability")],
...
async def notify_admin(context: ContextTypes.DEFAULT_TYPE, update: Update, request_id: int, request_type: str, message: str, lang: str) -> None:
    ...
    text = (
        ...
        f"الرسالة:\n{message}\n\n"
        "━━━━━━━━━━━━━━\n"
        "للرد المباشر على الطالب:\n"
        "اعمل Reply على هذه الرسالة داخل مجموعة الإدارة، واكتب ردك بشكل عادي.\n"
        "سيقوم البوت بإرسال ردك للطالب مباشرة.\n\n"
        "طريقة احتياطية:\n"
        f"/reply {target_id} اكتب ردك هنا"
    )

    try:
        sent = await context.bot.send_message(chat_id=ADMIN_CHAT_ID, text=text)
        if target_id:
            save_admin_message_map(sent.message_id, target_id, lang, request_id)
...
async def reply_to_user(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    Example:
    /reply 123456789 أهلاً أحمد، تم استلام طلبك وسنتواصل معك قريبًا.
    """
    upsert_user(update)

    if not ADMIN_CHAT_ID or update.effective_chat.id != ADMIN_CHAT_ID:
        await update.message.reply_text("هذا الأمر مخصص لمجموعة الإدارة فقط.")
        return

    if len(context.args) < 2:
        await update.message.reply_text(
            "طريقة الرد على الطالب:\n\n"
            "/reply USER_ID نص الرسالة\n\n"
            "مثال:\n"
            "/reply 123456789 أهلاً، تم استلام طلبك وسنتواصل معك قريبًا."
        )
        return
    ...
    try:
        ...
        await update.message.reply_text("رقم الطالب غير صحيح. انسخ الرقم الموجود بعد ID من رسالة الطلب.")
        return

    admin_message = " ".join(context.args[1:]).strip()
    if not admin_message:
        await update.message.reply_text("اكتب نص الرد بعد رقم الطالب.")
        return
    ...
    try:
        ...
        logger.exception("Could not reply to user: %s", exc)
        await update.message.reply_text(
            "لم أستطع إرسال الرد للطالب.\n"
            "تأكد أن الطالب بدأ المحادثة مع البوت ولم يحظر البوت."
        )
...
async def admin_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        "طريقة الرد المباشر على الطالب:\n\n"
        "1. اعمل Reply على رسالة الطلب التي أرسلها البوت في مجموعة الإدارة.\n"
        "2. اكتب ردك بشكل عادي.\n"
        "3. البوت سيرسل رسالتك للطالب مباشرة.\n\n"
        "مثال: اعمل Reply على طلب سامر، واكتب:\n"
        "أهلاً سامر، تم استلام طلبك وسنتواصل معك قريبًا.\n\n"
        "طريقة احتياطية عند الحاجة:\n"
        "/reply رقم_الطالب نص_الرسالة"
    )


async def handle_admin_group_reply(update: Update, context: ContextTypes.DEFAULT_TYPE) -> bool:
    """Allows the admin to reply directly by replying to the bot's request message in the admin group."""
    if not ADMIN_CHAT_ID or update.effective_chat.id != ADMIN_CHAT_ID:
        return False
    ...
    if not message.reply_to_message:
        # Ignore normal chat messages in the admin group.
        return True

    row = get_admin_message_map(message.reply_to_message.message_id)
    if not row:
        await message.reply_text(
            "ما قدرت أحدد الطالب من هذه الرسالة.\n\n"
            "للرد المباشر، اعمل Reply على رسالة الطلب الأصلية التي أرسلها البوت.\n"
            "أو استخدم الطريقة الاحتياطية:\n"
            "/reply رقم_الطالب نص_الرسالة"
        )
        return True

    target_user_id = int(row["user_id"])
    lang = row["language"] if row["language"] in TEXTS else "ar"
    ...
    try:
        ...
        await message.reply_text("تم إرسال رسالتك للطالب مباشرة ✅")
    except Exception as exc:
        logger.exception("Could not relay admin reply to user: %s", exc)
        await message.reply_text(
            "لم أستطع إرسال الرسالة للطالب.\n"
            "تأكد أن الطالب بدأ المحادثة مع البوت ولم يحظر البوت."
        )
...
async def on_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if data.startswith("menu:"):
        ...
        if item == "availability":
            await query.edit_message_text(t["availability_text"], reply_markup=back_keyboard(lang))
            return
...
async def on_text(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    if await handle_admin_group_reply(update, context):
        return
    ...
    if awaiting:
        ...
        context.user_data.clear()
        await update.message.reply_text(t["request_saved"])
        return
        ...
        try:
            sent = await context.bot.send_message(
                ...
                text=(
                    ...
                    "سيقوم البوت بإرسال ردك للطالب مباشرة.\n\n"
                    "طريقة احتياطية:\n"
                    f"/reply {user.id} اكتب ردك هنا"
                ),
            )
            save_admin_message_map(sent.message_id, user.id, lang, request_id)

            # Forward the actual attachment/message and map it too, so you can reply to the attachment as well.
            forwarded = await update.effective_message.forward(chat_id=ADMIN_CHAT_ID)
            save_admin_message_map(forwarded.message_id, user.id, lang, request_id)
        except Exception as exc:
            logger.exception("Could not forward attachment to admin: %s", exc)

    context.user_data.clear()
    await update.effective_message.reply_text(t["request_saved"])
