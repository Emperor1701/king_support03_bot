...
BOT_TOKEN = "8779362354:AAEnol8ALIlwnIfa1-0TyAf2c2sMAkQgtUQ"
...
def main() -> None:
    if BOT_TOKEN == "8779362354:AAEnol8ALIlwnIfa1-0TyAf2c2sMAkQgtUQ":
        raise RuntimeError("ضع توكن البوت في BOT_TOKEN أولاً.")
